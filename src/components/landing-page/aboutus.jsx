...
import AIModal from '@/components/aieye/aiModal';
...
const AboutUs = () => {
  ...
  return (
    <section id="about" className={styles['aboutus-section']}>
      ...
      <div className={styles.retinaScan}></div>
      <div className={styles.retinaScan2}></div>
      <div className={styles.lightPulse}></div>
      <div className={styles.lightPulse2}></div>
