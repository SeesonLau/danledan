...
const AppointmentsTable = ({ appointments, sortConfig, onSort, onStatusChange, onView }) => {
  return (
...
const AppointmentRow = ({ appointment, onStatusChange, onView }) => {
  return (
    <tr>
      ...
      <td data-label="Date">{new Date(appointment.appointmentDate).toLocaleDateString()}</td>
