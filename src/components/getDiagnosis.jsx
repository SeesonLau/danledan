export function getDiagnosis(distanceOD, distanceOS, nearOD, nearOS) {
  ...
  // Astigmatism
  if (
    (distanceOD.includes("/") || distanceOS.includes("/")) &&
    (distanceOD.includes("×") || distanceOS.includes("×"))
  ) {
  ...
  // Mixed Astigmatism
  if (
    (distanceOD.includes("+") && distanceOD.includes("-")) ||
    (distanceOS.includes("+") && distanceOS.includes("-"))
  ) {
...
// Wrapper for Firestore integration
export function determineDiagnosis(ehrData) {
  return getDiagnosis(
    ehrData.distanceOD || "",
    ehrData.distanceOS || "",
    ehrData.nearOD || "",
