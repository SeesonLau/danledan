...
const PatientSettings = () => {
  ...
  const getFullName = () => {
    const middleInitial = formData.middleName
  ...
  useEffect(() => {
    ...
    /*if (role != "Patient") {
      router.replace("/patient-homepage");
      return;
    }*/
        ...
        <>
          ...
          <div className={styles.profilePictureSection}>
            ...
            <div className={styles.userInfoContainer}>
              ...
              {imageUploading && (
                <p className={styles.uploadingIndicator}>Uploading image...</p>
              )}
            </div>
          </div>
      ...
      <div className={styles.policyContent}>
        ...
        <ul>
          <li>
            ...
            phone number, birthdate, sex, etc.
          </li>
          <li>
  ...
  const renderHelpTab = () => {
    const faqItems = [
      {
        question:
          "Where and How do I upload my Electronic Health Records (EHR)?",
        answer:
          "You can upload your Electronic Health Records (EHR) by navigating to the EHR section in the app's Navigation Bar. Simply tap the Upload button, select the files from your device, and confirm the upload. Make sure your documents are in an accepted format (e.g. PDF). If you encounter any issues, please refer to the Help Center or contact our support team for assistance.",
      },
      {
        question:
          "How do I book an appointment with a healthcare professional?",
        answer:
          "Navigate to the Appointments tab. Use the filters to search by specialization, location, or availability. Once you find a match, click Book Now and choose your preferred date and time.",
      },
      {
        question: "Can I edit my profile information after signing up?",
        answer:
          "Yes! Go to your Profile Settings, where you can update your personal details like name, contact number, email, address, and more.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Absolutely. We comply with the Data Privacy Act of 2012 (RA 10173) and use industry-standard encryption to keep your data safe and secure. You can read more in our Privacy Policy.",
      },
      {
        question: "How do I contact my assigned healthcare provider or mentor?",
        answer:
          "Once you've booked a session, go to the Appointments tab and select the session to view contact or chat options.",
      },
      {
        question: "Can I cancel or reschedule an appointment?",
        answer:
          "Yes, appointments can be canceled or rescheduled via the Appointments tab. Please cancel at least 24 hours in advance to avoid penalties.",
      },
      {
        question: "Do I need to pay for using Opticare?",
        answer:
          "Creating an account is free. However, consultation fees depend on the provider's rates. These are clearly displayed before you confirm a booking.",
      },
      {
        question: "Does Opticare support multiple languages?",
        answer:
          "Currently, Opticare is available in English and Filipino. We are working on adding more languages in future updates.",
      },
      {
        question: "Can I access Opticare on mobile and desktop?",
        answer:
          "Yes! Opticare is accessible through any modern browser and is also available on Android/iOS through the official Opticare app.",
      },
    ];
        ...
        <div className={styles.helpContainer}>
          <div className={styles.helpScrollContent}>
            ...
            <p className={styles.helpIntro}>
              Welcome to the <strong>Opticare Help Center</strong> — your go-to
              resource for guidance and assistance on using our platform.
              Whether you're a first-time user or a returning patient, we're
              here to help you navigate your healthcare journey with ease.
            </p>
