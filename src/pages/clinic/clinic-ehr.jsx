...
const ClinicEHR = () => {
  ...
  const [date, setBirthdate] = useState('');
   ...
   const patients = [ // - - TEMPORARY
    { caseNo: "0001", name: "John Doe", lastVisit: "15/02/2025", diagnosis: "Myopia", prescription: "-2.00 / -1.50" },
    { caseNo: "0002", name: "Jane Smith", lastVisit: "20/02/2025", diagnosis: "Hyperopia", prescription: "+1.50 / +1.00" },
    { caseNo: "0003", name: "Michael Johnson", lastVisit: "10/03/2025", diagnosis: "Astigmatism", prescription: "-1.25 / -0.75" },
    { caseNo: "0004", name: "Emily Davis", lastVisit: "05/04/2025", diagnosis: "Myopia", prescription: "-3.00 / -2.50" },
    { caseNo: "0005", name: "David Brown", lastVisit: "12/05/2025", diagnosis: "Presbyopia", prescription: "+2.00 / +2.00" },
    { caseNo: "0006", name: "Olivia Wilson", lastVisit: "25/06/2025", diagnosis: "Hyperopia", prescription: "+1.75 / +1.25" },
    { caseNo: "0007", name: "Sophia Martinez", lastVisit: "30/07/2025", diagnosis: "Astigmatism", prescription: "-2.00 / -1.00" },
    { caseNo: "0008", name: "Ethan Taylor", lastVisit: "08/08/2025", diagnosis: "Myopia", prescription: "-1.75 / -1.25" },
    { caseNo: "0009", name: "Charlotte White", lastVisit: "18/09/2025", diagnosis: "Hyperopia", prescription: "+2.25 / +1.75" },
    { caseNo: "0010", name: "Liam Anderson", lastVisit: "05/10/2025", diagnosis: "Astigmatism", prescription: "-1.50 / -1.00" },
    { caseNo: "0011", name: "Benjamin Clark", lastVisit: "10/11/2025", diagnosis: "Myopia", prescription: "-2.25 / -1.75" },
    { caseNo: "0012", name: "Emma Garcia", lastVisit: "15/12/2025", diagnosis: "Hyperopia", prescription: "+1.25 / +1.00" },
    { caseNo: "0013", name: "Lucas Harris", lastVisit: "22/01/2026", diagnosis: "Presbyopia", prescription: "+2.50 / +2.50" },
    { caseNo: "0014", name: "Ava Moore", lastVisit: "28/02/2026", diagnosis: "Astigmatism", prescription: "-1.50 / -0.75" },
    { caseNo: "0015", name: "Mason Hall", lastVisit: "12/03/2026", diagnosis: "Myopia", prescription: "-3.25 / -2.75" },
    { caseNo: "0016", name: "Mia Young", lastVisit: "20/04/2026", diagnosis: "Hyperopia", prescription: "+1.75 / +1.50" },
    { caseNo: "0017", name: "James Walker", lastVisit: "05/05/2026", diagnosis: "Astigmatism", prescription: "-1.75 / -1.25" },
    { caseNo: "0018", name: "Isabella King", lastVisit: "18/06/2026", diagnosis: "Presbyopia", prescription: "+2.25 / +2.00" },
    { caseNo: "0019", name: "William Wright", lastVisit: "25/07/2026", diagnosis: "Myopia", prescription: "-2.50 / -2.00" },
    { caseNo: "0020", name: "Amelia Scott", lastVisit: "08/08/2026", diagnosis: "Hyperopia", prescription: "+1.50 / +1.25" },
  ];

  // Function to handle row click - TEMPORARY
                    ...
                    <div className={styles.tableContainer}>
                        <table className={styles.table}>
                            ...
                            {patients.map((patient, index) => (
                                ...
                                <td className={styles.td} style={{ fontWeight: "bold", color: "#004085" }}>
                                    {patient.name}
                                </td>
                                ...
                                <td className={`${styles.td} ${styles.actions}`} onClick={(e) => e.stopPropagation()}>
                                <button className={styles.button} onClick={() => viewPatient(patient)}>
                                    <FaEye />
                                </button>
                                <input
                                    id="file-input"
                                ...
                                <button className={styles.button} onClick={() => exportEHR(printRef)}>
                                    <FaPrint />
                                </button>
