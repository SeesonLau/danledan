...
const ClinicSettings = () => {
  ...
  const uploadProfilePicture = async () => {
    ...
    try {
      ...
      const storageRef = ref(storage, `clinic_pictures/${user.uid}/${fileName}`);
        ...
        try {
          ...
          if (userDoc.exists()) {
            ...
            setFormData({
              ...
              ownerMiddleName: userData.ownerMiddleName || "", // New field
          ...
          setSaveMessage({ 
            type: "error", 
            message: "Could not load your clinic profile data. Please try again later." 
          });
        } finally {
          setIsLoading(false);
        }
    ...
    <div className={styles.profileFormWrapper}>
      <div className={styles.profileFormScroll}>
        <form className={styles.profileForm} onSubmit={handleSubmit}>
          {isLoading ? (
            <div style={{ textAlign: 'center' }}>Loading your clinic profile data...</div>
          ) : (
            <>
              {saveMessage.message && (
  ...
  const renderPrivacyTab = () => (
    <div className={styles.privacyPolicy}>
      ...
      <div className={styles.policyContent}>
        ...
        <ul>
          <li><strong>Personal Identification Data:</strong> Name, email address, phone number, clinic details, license information, etc.</li>
    ...
    const faqItems = [
      {
        ...
        answer: "You can manage your clinic's schedule by navigating to the Schedule section in the app's Navigation Bar. From there, you can set regular hours, block off unavailable times, and customize your appointment slots. The system also allows you to set specific services with different durations and capacity limits."
      },
      {
        question: "How do I view and manage patient appointments?",
        answer: "Navigate to the Appointments tab. You can view all upcoming appointments, filter by date or status, and take actions like confirming, rescheduling, or canceling appointments. Each appointment card shows essential patient information and appointment details."
      },
      {
        question: "Can I edit my clinic profile information after signing up?",
        answer: "Yes! Go to your Profile Settings, where you can update your clinic details like name, address, contact information, services offered, and more."
      },
      {
      ...
      },
      {
        ...
        answer: "Very secure. We comply with the Data Privacy Act of 2012 (RA 10173) and use industry-standard encryption to keep your data safe. All sensitive patient information is encrypted and access is strictly controlled."
      },
      {
        question: "How do I communicate with patients through the platform?",
        answer: "Use the Messages section to send and receive communications from patients. You can send appointment reminders, follow-up messages, and respond to patient inquiries."
      },
      {
        question: "Can I cancel or reschedule a patient's appointment?",
        answer: "Yes, you can manage all appointments via the Appointments tab. When rescheduling, patients will automatically receive a notification about the change with options to confirm the new time."
      },
      {
        question: "How do I set up my billing information and payment methods?",
        answer: "Go to the Financial Settings section under the main Settings tab. There you can add your bank account details, set up online payment options, and manage your subscription to Opticare's services."
      },
      {
        question: "How do I customize the services my clinic offers?",
        answer: "In the Services section of your clinic profile, you can add, edit, or remove services. For each service, you can set duration, price, description, and availability."
      },
      {
        question: "Can I access reports and analytics about my clinic activity?",
        answer: "Yes! The Analytics dashboard provides insights on appointment volume, patient demographics, popular services, revenue tracking, and more to help optimize your clinic operations."
      }
    ];
      ...
      <div className={styles.helpPage}>
        <div className={styles.helpContainer}>
          <div className={styles.helpScrollContent}>
            <h3 className={styles.helpTitle}>Opticare Help & Support for Clinics</h3>
            
            <p className={styles.helpIntro}>Welcome to the <strong>Opticare Clinic Help Center</strong> — your resource for guidance on managing your healthcare practice through our platform. We're here to help you optimize your clinic operations and provide excellent care to your patients.</p>
            
            <div className={styles.contactSection}>
              <h4>📞 Contact Us</h4>
              <p>Need personalized help? Our clinic support team is ready to assist you.</p>
              <p><strong>Clinic Support Hotline:</strong> 📞 <span className={styles.contactInfo}>286-8970</span></p>
              <p><strong>Email Support:</strong> 📧 <span className={styles.contactInfo}>clinic-support@danledan.corporation.inc</span></p>
            </div>
